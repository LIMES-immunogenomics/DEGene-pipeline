...
setwd("E:/Nico/GitHub-Deseq2/clusterprofiler")
# vorher setwd machen
...
## Example:
# load your genes of interest into your DE gene list
# you need a gmt file in your working directory to look for hallmarks
# if you don't have the package qpcR, you need to install it
# install.packages("qpcR")
setwd()

functional_prediction(input_file= DE_object$CON_GM@parameters[[1]],
                      cond= "merged",
                      orga_type="human",
                      DE_gene_list= list("all_up"=head(all_upreg_genes,100),
                                         "all_down"=head(all_downreg_genes,100)),
